...
@section('title')
<h1> <i class='fa fa-bookmark' ></i> Modificar Empresa</h1>
@endsection
...
<div class="col-lg-7">
    <?php
        ...
        $form = array(
            'url'       => URL::route(\Config::get('ecsa::prefix').'.organization.update', array('id' => \Crypt::encrypt($org->id))),
            'method'    => 'PATCH',
            'defaults'  => array(
